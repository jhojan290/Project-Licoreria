...
@section('title', 'Contacto | Estanquillo Fry')
@section('content')
    ...
    <div class="container mx-auto px-4 py-12 md:py-16">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6 lg:col-span-1 h-fit">
                ...
                <a href="https://wa.me/573212159455" target="_blank" class="group block bg-gradient-to-br from-[#1E1E1E] to-[#181611] border border-white/10 rounded-2xl p-6 hover:border-[#25D366]/50 transition-all hover:-translate-y-1 relative overflow-hidden shadow-lg">
                    ...
                    <div class="relative z-10 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-green-400 text-sm font-mono font-bold mt-1">+57 321 215 9455</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="lg:col-span-2 space-y-8 flex flex-col">
                ...
                <div class="bg-[#181611] border border-white/10 rounded-2xl p-2 flex-grow min-h-[400px] relative group">
                    <div class="w-full h-full rounded-xl overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 relative">
                        <iframe
                            src="https://www.google.com/maps?q=ESTANQUILLO%20Fry%20%404.8404026,-75.6740811&z=18&output=embed"
                        ...
                        <div class="absolute top-4 left-4 bg-[#121212]/90 backdrop-blur-md border border-[#D4AF37]/30 px-4 py-2 rounded-lg shadow-xl z-10 pointer-events-none">
                            ...
                            <p class="text-white text-sm font-bold">ESTANQUILLO Fry</p>
                        </div>
                    </div>
                </div>
