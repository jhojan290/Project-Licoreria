                    ...
                    @if($product->stock > 0)
                        <div class="space-y-6">
                            ...
                            >
                                ...
                                <span wire:loading.flex wire:target="addToCart" class="items-center gap-3">
                                    <svg class="animate-spin h-6 w-6 text-[#121212]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
