        ...
        <div class="flex items-center justify-between py-4">
            ...
            <div class="flex flex-1 items-center justify-end gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button wire:click="$dispatch('openSidebar', { title: 'Iniciar Sesión', partial: 'login' })" class="flex h-10 w-10 items-center justify-center rounded-lg text-zinc-300 hover:bg-white/10 hover:text-primary transition-colors cursor-pointer">
                    ...
                    <button wire:click="$dispatch('openSidebar', { title: 'Crear Cuenta', partial: 'createUser' })" class="hidden lg:flex h-10 min-w-[84px] max-w-[480px] items-center justify-center rounded-lg px-4 bg-primary text-background-dark text-sm font-bold tracking-wide leading-normal overflow-hidden truncate hover:bg-yellow-400 transition-colors focus:outline-none focus:ring-4 focus:ring-primary/30 cursor-pointer">
                        Crear Cuenta
                    </button>
                </div>
            </div>
