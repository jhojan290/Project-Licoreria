<div class="w-full h-full flex flex-col justify-between p-4">
    ...
    <form wire:submit="login" class="flex flex-col gap-6 px-2">
        ...
        <button
            ...
            class="flex h-14 items-center justify-center rounded-lg bg-primary text-background-dark text-lg font-bold 
    ...
    <div class="text-center text-sm font-medium pt-8">
        ...
        <a href="#" class="text-primary hover:underline font-bold">
            Crear una cuenta
        </a>
    </div>
