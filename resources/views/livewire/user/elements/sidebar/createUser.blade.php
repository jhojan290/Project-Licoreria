<div class="w-full h-full flex flex-col justify-center p-6 gap-8">
    ...
    <form wire:submit="register" class="flex flex-col gap-5">
        ...
        <label class="flex flex-col gap-1" x-data="{ show: false }">
            ...
            <div class="relative flex items-center">
                ...
                <button 
                    @click="show = !show" 
                    type="button" 
                    class="absolute right-2 text-text-secondary-light dark:text-text-secondary-dark hover:text-primary transition-colors focus:outline-none"
                >
        ...
        <button
            ...
            class="h-11 flex items-center justify-center rounded-lg bg-primary text-background-dark text-base font-bold 
            hover:opacity-90 transition shadow-lg shadow-primary/20 mt-2 disabled:opacity-50 disabled:cursor-not-allowed">
    ...
    <div class="text-center text-sm font-medium">
        ...
        <button 
            type="button"
            wire:click="$dispatch('change-sidebar-view', { view: 'login', title: 'Iniciar Sesión' })"
